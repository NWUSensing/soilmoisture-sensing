...
while 1:
    ...
    if previous_size < current_size :
        ...
        f = open(file_path,'r')
        # previous_size=previous_size-flag3
        ...
        # print(len(line))
        # break
        while len(line) > 50 and len(line.split(',')) == 9 and len(line.split(',')[0]) == 4:
            # print("i am :",line)
            # print("len:",len(line))
            ...
            if temp != -1 and A_1[temp] and B_1[temp]  and TAG[temp] == -1:
                ...
                print("Detected sensor ID: ", temp + 1)
                print("----------------")
            ...
            if flag == 0  and i >= MAX:
                ...
                print("Detected those tags: ",end = " ")
                for k in range(0,len(A)):
                    if(TAG[k] != -1):
                        print(k+1,end="  ")
                print("\nPlease input the sensor ID that you want to save its data:",end = " ")
